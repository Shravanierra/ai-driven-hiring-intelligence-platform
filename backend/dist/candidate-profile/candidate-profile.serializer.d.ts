...
export declare const CANDIDATE_PROFILE_V1_SCHEMA: {
...
export declare function serializeCandidateProfile(profile: CandidateProfile): string;
export declare function deserializeCandidateProfile(json: string): CandidateProfile;
